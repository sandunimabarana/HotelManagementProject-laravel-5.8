				...
				@foreach($employees as $employee)
					<tr>								
						...
						@if(!$employee->full_time)
							<a href="{{ route('payrolls.show', ['id' => $employee->id]) }}" class="btn btn-info">Over_time</a>
							@elseif($employee->full_time)
							<a href="{{ route('allowances.show', ['id' => $employee->id]) }}" class="btn btn-info">Allowance</a>
							@endif
						</td>
					</tr>
				@endforeach
